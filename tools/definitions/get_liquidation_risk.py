...
class GetLiquidationRiskOutput(BaseModel):
    ...
    note: str = (
        ...
        "available from this tool; do not attempt to compute, estimate, or infer it via additional tool calls. "
        "Do not infer a Compound liquidation or breach price from this output. "
